...
check_token() {
  ...
  if [ "$USER_TOKEN" = "yp" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Token Salah! Beli Kode Token Di Skyzopedia${NC}"
    echo -e "${YELLOW}TELEGRAM : @yp${NC}"
    echo -e "${YELLOW}WHATSAPP : +yp${NC}"
    echo -e "${YELLOW}yp${NC}"
    echo -e "${YELLOW}© yp${NC}"
    exit 1
  fi
...
install_theme() {
  ...
  THEME_URL="https://github.com/NaufalYupra/Pterodactyl-Theme-Autoinstaller/raw/main/${THEME_NAME}.zip"
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/NaufalYupra/Pterodactyl-Theme-Autoinstaller/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
# Unduh file tema
wget -O /root/stellar.zip https://github.com/NaufalYupra/Pterodactyl-Theme-Autoinstaller/raw/main/stellar.zip
